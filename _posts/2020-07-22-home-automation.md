...
So we have to build something on our own. So we will build a small backend that can communicate with the IKEA gateway and control our plugs based on some API endpoints.
